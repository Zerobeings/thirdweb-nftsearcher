...
const NFTSearcher = _ref => {
  ...
  const [twContractAddress, setTWContractAddress] = React.useState('');
  const [isProcessing, setIsProcessing] = React.useState(false);
  const [showSuggestions, setShowSuggestions] = React.useState(false);
  const [collections, setCollections] = React.useState([]);
  const [collectionCache, setCollectionCache] = React.useState({});
  const [lastUsedContractAddress, setLastUsedContractAddress] = React.useState('');
  onNFTsFetched = onNFTsFetched || (() => {});

  // Styling and theme
  const [hoveredIndex, setHoveredIndex] = React.useState(null);
  const darkTheme = React.useMemo(() => theme === 'dark', [theme]);
  const styling = {
    searchContainer: {
      position: 'relative',
  ...
  const {
    contract
  } = reactCore.useContract(twContractAddress);
  const {
    data: nfts
  } = reactCore.useNFTs(contract, {
    count: limit,
    start: start
  });
  React.useEffect(() => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      }) : /*#__PURE__*/jsxRuntime.jsx(MediaRenderer, {
        style: styling.networkImage,
        src: "https://bafybeie3c5fcqjhrfma6wljpwzzldpsttu2lonutagoxwikeslersqzdwe.ipfs.dweb.link/eth.png",
        alt: "ethereum",
        width: "30px",
      ...
      }), contractAddress && /*#__PURE__*/jsxRuntime.jsx("button", {
    ...
    }), showSuggestions && /*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: collections && collections.length > 0 ? collections.filter(collection => {
      ...
      }).slice(0, 6).map((collection, index) => /*#__PURE__*/jsxRuntime.jsxs("div", {
        style: {
          ...styling.suggestion,
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(MediaRenderer, {
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-fd1debda.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-fd1debda.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async options => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-fd1debda.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-fd1debda.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-4ffddeb6.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-cf7eceb7.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-1aad1f73.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-fd1debda.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
...
exports.NFTSearcher = NFTSearcher;
